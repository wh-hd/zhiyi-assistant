"""
智医助手 — 配置数据 API
返回 data.js 中定义的静态配置（前端 tab/screen/设置等）
"""
...
def get_config():
    ...
    return {
        ...
        "data": {
            ...
            "tabScreenMap": {
                "home": "home", "consult": "consult", "archive": "archive",
                "profile": "profile", "assess": "home", "meds": "home",
                "metrics": "home", "assess-report": "home", "member-detail": "archive",
                "add-member": "archive", "add-med": "home", "record-metric": "home",
                "settings": "profile", "about": "profile"
            },
            "screenOrder": [
                "screen-home", "screen-assess", "screen-assess-report",
                "screen-consult", "screen-archive", "screen-member-detail",
                "screen-add-member", "screen-meds", "screen-add-med",
                "screen-metrics", "screen-record-metric",
                "screen-profile", "screen-settings", "screen-about"
            ],
            "assessment": {
                "pageTitle": "家庭健康自评",
                ...
                "initialIndex": 2,
                "questions": [
                    {"q": "你最担心家人的哪些健康问题？", "sub": "可多选",
                     "options": ["儿童成长发育", "老人日常照护", "心理健康情绪", "慢性病管理"]},
                    {"q": "家人目前有哪些慢性病管理需求？", "sub": "可多选",
                     "options": ["高血压管理", "糖尿病管理", "高血脂管理", "暂无慢性病"]},
                    {"q": "你最希望获得哪些健康服务？", "sub": "可多选",
                     "options": ["定期健康提醒", "家庭健康报告", "在线健康咨询", "就医绿色通道"]},
                    {"q": "你认为家庭健康管理最大的困难是什么？", "sub": "可多选",
                     "options": ["信息不统一", "坚持困难", "缺乏专业指导", "时间精力不足"]},
                ],
                "initialSelected": [2]
            },
            "addMember": {
            ...
            "recordMetric": {
                "pageTitle": "记录指标",
                "types": [
                    {"key": "bp", "label": "血压", "iconBg": "rgba(208,128,104,.1)", "iconStroke": "#D08068",
                     "icon": '<path d="M3 12h4l3-8 4 16 3-8h4"/>'},
                    {"key": "weight", "label": "体重", "iconBg": "rgba(216,149,117,.1)", "iconStroke": "#D89575",
                     "icon": '<rect x="3" y="8" width="18" height="8" rx="4"/>'},
                    {"key": "glucose", "label": "血糖", "iconBg": "rgba(212,166,74,.1)", "iconStroke": "#D4A64A",
                     "icon": '<circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 2"/>'},
                    {"key": "hr", "label": "心率", "iconBg": "rgba(61,138,90,.1)", "iconStroke": "#3D8A5A",
            ...
            "settings": {
                ...
                "privacy": [
                    {"label": "健康数据授权管理", "type": "arrow", "toast": "授权管理功能开发中"},
                    {"label": "匿名化数据分享", "type": "toggle", "enabled": False},
                ],
                "data": [
                    {"label": "导出健康数据", "type": "arrow", "toast": "数据导出功能开发中"},
                    {"label": "清除本地缓存", "type": "arrow", "value": "23.5MB", "toast": "缓存已清除"},
                ],
                "account": [
                    {"label": "修改密码", "type": "arrow", "toast": "修改密码功能开发中"},
            ...
            "home": {
                "quickActions": [
                    {"label": "AI 咨询", "target": "consult", "bgColor": "rgba(61,138,90,.1)", "strokeColor": "#3D8A5A",
                     "icon": '<path d="M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z"/>'},
                    {"label": "用药提醒", "target": "meds", "bgColor": "rgba(216,149,117,.1)", "strokeColor": "#D89575",
                     "icon": '<rect x="3" y="8" width="18" height="8" rx="4"/><circle cx="8" cy="12" r="1.5" fill="#D89575"/><line x1="12" y1="10" x2="12" y2="14"/>'},
                    {"label": "指标记录", "target": "metrics", "bgColor": "rgba(208,128,104,.1)", "strokeColor": "#D08068",
                     "icon": '<path d="M3 12h4l3-8 4 16 3-8h4"/>'},
                    {"label": "健康自评", "target": "assess", "bgColor": "rgba(212,166,74,.1)", "strokeColor": "#D4A64A",
            ...
            "meds": {
                "pageTitle": "用药提醒",
                "summary": {"title": "今日用药进度", "taken": 3, "total": 4}
            },
            "metrics": {
                "pageTitle": "健康指标",
                "currentLabel": "当前指标",
            ...
            "profile": {
                "pageTitle": "我的",
                "menuItems": [
                    {"text": "家庭健康档案", "action": "screen:archive", "iconBg": "rgba(61,138,90,.1)", "iconStroke": "#3D8A5A",
                     "icon": '<path d="M3 7V19a2 2 0 002 2h14a2 2 0 002-2V7M3 7L5 3h14l2 4M9 11h6"/>'},
                    {"text": "健康自评记录", "action": "screen:assess", "iconBg": "rgba(212,166,74,.1)", "iconStroke": "#D4A64A",
                     "icon": '<rect x="5" y="3" width="14" height="18" rx="2"/><path d="M9 8h6M9 12h6M9 16h4"/>'},
                    {"text": "用药管理", "action": "screen:meds", "iconBg": "rgba(216,149,117,.1)", "iconStroke": "#D89575",
                     "icon": '<rect x="3" y="8" width="18" height="8" rx="4"/>'},
                    {"text": "设置", "action": "screen:settings", "iconBg": "rgba(139,139,136,.1)", "iconStroke": "#8B8B88",
                    ...
                    {"text": "关于我们", "action": "screen:about", "iconBg": "rgba(61,138,90,.1)", "iconStroke": "#3D8A5A",
                     "icon": '<circle cx="12" cy="12" r="10"/><path d="M12 16v-4M12 8h.01"/>'},
                ]
            },
            "memberDetail": {"pageTitle": "健康档案"},
