  ...
  /* ========================================
     Auth State (shared across all scopes)
     ensureMemberContext() 与内部 IIFE 的 apiFetch/syncFromBackend 共享同一份
     authToken / refreshToken / authUserId，避免「applyTokens is not defined」作用域错误。
     ======================================== */
  var authToken = null;
  ...
  function applyTokens(payload) {
    authToken = payload && (payload.accessToken || payload.access_token) || authToken;
  ...
  var DEFAULT_CONFIG = {
    ...
    "tabScreenMap": {
      ...
      "assess-history": "home", "assess-history-detail": "home",
      "metric-history": "home", "device-sync": "home", "task-edit": "home",
    ...
    "screenOrder": [
      ...
      "screen-assess-history", "screen-assess-history-detail",
      "screen-consult", "screen-archive", "screen-member-detail", "screen-add-member",
      "screen-edit-member", "screen-meds", "screen-add-med", "screen-metrics", "screen-record-metric",
      "screen-metric-history", "screen-device-sync", "screen-task-edit",
    ...
    "recordMetric": {
      "pageTitle": "记录指标",
      "types": [
        { "key": "bp", "label": "血压", "metricType": "blood_pressure", "unit": "mmHg", "category": "vital", "inputMode": "dual",
          "iconBg": "rgba(208,128,104,.1)", "iconStroke": "#D08068", "icon": "<path d=\"M3 12h4l3-8 4 16 3-8h4\"/>" },
        { "key": "weight", "label": "体重", "metricType": "weight", "unit": "kg", "category": "body", "inputMode": "single",
          "iconBg": "rgba(216,149,117,.1)", "iconStroke": "#D89575", "icon": "<rect x=\"3\" y=\"8\" width=\"18\" height=\"8\" rx=\"4\"/>" },
        { "key": "bmi", "label": "BMI", "metricType": "bmi", "unit": "", "category": "body", "inputMode": "single",
          "iconBg": "rgba(180,140,200,.1)", "iconStroke": "#B48CC8", "icon": "<path d=\"M12 2a10 10 0 100 20 10 10 0 000-20zM8 12h8M12 8v8\"/>" },
        { "key": "body_fat", "label": "体脂率", "metricType": "body_fat", "unit": "%", "category": "body", "inputMode": "single",
          "iconBg": "rgba(120,150,180,.1)", "iconStroke": "#7896B4", "icon": "<circle cx=\"12\" cy=\"12\" r=\"9\"/><path d=\"M8 12a4 4 0 018 0\"/>" },
        { "key": "glucose", "label": "血糖", "metricType": "blood_glucose", "unit": "mmol/L", "category": "vital", "inputMode": "select",
          "iconBg": "rgba(212,166,74,.1)", "iconStroke": "#D4A64A", "icon": "<circle cx=\"12\" cy=\"12\" r=\"9\"/><path d=\"M12 7v5l3 2\"/>" },
        { "key": "hr", "label": "心率", "metricType": "heart_rate", "unit": "bpm", "category": "vital", "inputMode": "single",
          "iconBg": "rgba(61,138,90,.1)", "iconStroke": "#3D8A5A", "icon": "<path d=\"M20.84 4.61a5.5 5.5 0 00-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 00-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 000-7.78z\"/>" },
        { "key": "spo2", "label": "血氧", "metricType": "spo2", "unit": "%", "category": "vital", "inputMode": "single",
          "iconBg": "rgba(100,180,160,.1)", "iconStroke": "#64B4A0", "icon": "<path d=\"M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z\"/>" },
        { "key": "temperature", "label": "体温", "metricType": "temperature", "unit": "°C", "category": "vital", "inputMode": "single",
          "iconBg": "rgba(220,120,100,.1)", "iconStroke": "#DC7864", "icon": "<path d=\"M14 14.76V3.5a2.5 2.5 0 00-5 0v11.26a4.5 4.5 0 105 0z\"/>" },
        { "key": "steps", "label": "步数", "metricType": "steps", "unit": "步", "category": "activity", "inputMode": "single",
          "iconBg": "rgba(80,160,220,.1)", "iconStroke": "#50A0DC", "icon": "<path d=\"M13 4v4h4M17 8l-6.5 6.5a2.12 2.12 0 01-3 0 2.12 2.12 0 010-3L14 2M8 15l3 3\"/>" },
        { "key": "sleep", "label": "睡眠", "metricType": "sleep", "unit": "小时", "category": "activity", "inputMode": "single",
          "iconBg": "rgba(100,100,160,.1)", "iconStroke": "#6464A0", "icon": "<path d=\"M21 12.79A9 9 0 1111.21 3 7 7 0 0021 12.79z\"/>" },
        { "key": "stress", "label": "压力", "metricType": "stress", "unit": "分", "category": "wellness", "inputMode": "single",
          "iconBg": "rgba(180,120,140,.1)", "iconStroke": "#B4788C", "icon": "<path d=\"M12 2v4M12 18v4M4.93 4.93l2.83 2.83M16.24 16.24l2.83 2.83M2 12h4M18 12h4M4.93 19.07l2.83-2.83M16.24 7.76l2.83-2.83\"/>" }
      ],
      "measurers": [],
    ...
    "meds": {
      "pageTitle": "用药提醒",
      "summary": { "title": "今日用药", "taken": 0, "total": 0 },
      "medications": [],
    ...
    "profile": {
      ...
      "menuItems": [
        ...
        { "text": "健康自评记录", "action": "screen:assess-history", "iconBg": "rgba(212,166,74,.1)", "iconStroke": "#D4A64A", "icon": "<rect x=\"5\" y=\"3\" width=\"14\" height=\"18\" rx=\"2\"/><path d=\"M9 8h6M9 12h6M9 16h4\"/>" },
  ...
  /* ========================================
     待办事项：图标预设 + 辅助函数
     ======================================== */
  var TASK_ICON_PRESETS = {
    clipboard: { path: '<path d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/>', bg: 'rgba(61,138,90,.1)', stroke: '#3D8A5A' },
    pill:      { path: '<rect x="3" y="8" width="18" height="8" rx="4"/><circle cx="8" cy="12" r="1.5" fill="currentColor"/><line x1="12" y1="10" x2="12" y2="14"/>', bg: 'rgba(216,149,117,.1)', stroke: '#D89575' },
    activity:  { path: '<path d="M3 12h4l3-8 4 16 3-8h4"/>', bg: 'rgba(208,128,104,.1)', stroke: '#D08068' },
    heart:     { path: '<path d="M20.8 5.6a5.5 5.5 0 00-7.8 0L12 6.6l-1-1a5.5 5.5 0 10-7.8 7.8L12 21l8.8-8.6a5.5 5.5 0 000-7.8z"/>', bg: 'rgba(212,90,90,.1)', stroke: '#D45A5A' },
    calendar:  { path: '<rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/>', bg: 'rgba(96,140,212,.1)', stroke: '#608CD4' },
    droplet:   { path: '<path d="M12 2.7l5.7 5.7a8 8 0 11-11.4 0L12 2.7z"/>', bg: 'rgba(64,160,200,.1)', stroke: '#40A0C8' },
    moon:      { path: '<path d="M21 12.8A9 9 0 1111.2 3 7 7 0 0021 12.8z"/>', bg: 'rgba(120,110,200,.1)', stroke: '#786EC8' },
    stethoscope:{ path: '<path d="M4 3v6a5 5 0 0010 0V3M4 3H2m12 0h-2M9 14v3a5 5 0 0010 0v-2"/><circle cx="19" cy="13" r="2"/>', bg: 'rgba(80,170,140,.1)', stroke: '#50AA8C' },
  };

  function taskIconSvg(key) {
    var p = TASK_ICON_PRESETS[key];
    return p ? p.path : (TASK_ICON_PRESETS.clipboard.path);
  }
  ...
  function renderHome() {
    ...
    // Score card
    var scoreCardAttrs = 'class="score-card"';
    var scoreHint = '';
    if (h.healthScore.needAssessment) {
      scoreCardAttrs = 'class="score-card" onclick="switchScreen(\'assess\')" style="cursor:pointer;"';
      scoreHint = '<div style="font-size:11px;color:#8A8A85;margin-top:4px;">点击完成健康自评，获取评分</div>';
    }
    html += '<div ' + scoreCardAttrs + '><div>' +
      '<div class="score-label">' + h.healthScore.label + '</div>' +
      '<div class="score-value">' + h.healthScore.value + '</div>' + scoreHint + '</div>' +
    ...
    h.familyMembers.forEach(function(m, i) {
      html += '<div class="fm-card" onclick="openMemberDetail(\'' + m.id + '\')">' +
    ...
    // Tasks
    var openCount = (h.tasks || []).filter(function(t) { return !t.done; }).length;
    html += '<div class="tt-header"><span class="section-label">今日健康任务</span>' +
      '<span class="tt-count" id="task-count">' + openCount + '项待办</span>' +
      '<button class="tt-add-btn" onclick="openTaskEditor(null)">+ 新建</button></div>';
    if (!h.tasks || !h.tasks.length) {
      html += '<div class="task-empty" onclick="openTaskEditor(null)">' +
        '<div class="task-empty-icon">' + SVG.check + '</div>' +
        '<div class="task-empty-text">暂无待办事项</div>' +
        '<div class="task-empty-sub">点击此处添加今日健康任务</div></div>';
    } else {
      h.tasks.forEach(function(t) {
        var due = t.dueDate ? formatTaskDue(t.dueDate) : '';
        html += '<div class="task-card' + (t.done ? ' done' : '') + '" data-task-id="' + t.id + '">' +
          '<div class="task-check' + (t.done ? ' on' : '') + '" onclick="toggleTaskDone(\'' + t.id + '\', event)">' +
            (t.done ? SVG.check : '') + '</div>' +
          '<div class="task-info" onclick="openTaskEditor(\'' + t.id + '\')">' +
            '<div class="task-title">' + escapeHtml(t.title) + '</div>' +
            (t.detail ? '<div class="task-detail">' + escapeHtml(t.detail) + '</div>' : '') +
            (due ? '<div class="task-due">🕒 ' + due + '</div>' : '') +
          '</div>' +
          '<div class="task-icon" style="background:' + (t.iconBg || 'rgba(61,138,90,.1)') + '">' +
            '<svg viewBox="0 0 24 24" fill="none" stroke="' + (t.iconStroke || '#3D8A5A') + '" stroke-width="2">' + taskIconSvg(t.icon) + '</svg>' +
          '</div>' +
          '<div class="task-del" onclick="deleteTaskItem(\'' + t.id + '\', event)" title="删除">✕</div>' +
        '</div>';
      });
    }
  ...
  async function loadAssessFirstQuestion() {
    ...
    try {
      ...
      if (!memberId) {
        throw new Error('无法解析家庭成员，请刷新页面后重试');
      }
  ...
  function renderAssessQuestion() {
    ...
    var isLastStep = assessStep >= assessTotalSteps;
    var btn = document.getElementById('assess-continue');
    if (btn) {
      btn.disabled = false;
      btn.textContent = isLastStep ? '完成自评' : '继续';
    }
  }
  ...
  function renderChatMsg(msg) {
    ...
    var statusTag = msg.statusTag
      ...
      : '';
    var contentHtml = (msg.type === 'ai' && msg.text)
      ? renderMarkdown(msg.text)
      : escapeHtml(msg.text || '');
    return '<div class="chat-msg ' + (msg.type === 'user' ? 'self' : '') + '">' +
      avatar + '<div class="chat-bubble">' + contentHtml + statusTag + '</div></div>';
  }
  ...
  function renderArchive() {
    ...
    a.members.forEach(function(m) {
      var act = m.action || 'screen:member-detail';
      var onclick;
      if (act.indexOf('toast:') === 0) {
        onclick = 'showToast(\'' + act.substring(6) + '\')';
      } else if (act.indexOf('screen:member-detail') === 0 && m.id) {
        onclick = 'openMemberDetail(\'' + m.id + '\')';
      } else if (act.indexOf('screen:') === 0) {
        onclick = 'switchScreen(\'' + act.substring(7) + '\')';
      } else {
        onclick = 'switchScreen(\'' + act + '\')';
      }
      html += '<div class="member-card" onclick="' + onclick + '">' +
        ...
        '<span class="member-action-btn edit" onclick="event.stopPropagation(); openMemberEdit(\'' + m.id + '\')">编辑</span>' +
        '<span class="member-action-btn delete" onclick="event.stopPropagation(); deleteMember(\'' + m.id + '\')">删除</span>' +
        '</div></div>';
    });
    html += '</div>';
  ...
  function renderMeds() {
    ...
    // Summary
    var taken = m.summary.taken || 0, total = m.summary.total || 0;
    var pct = total ? Math.round((taken / total) * 100) : 0;
    html += '<div class="med-summary">' +
      '<div class="ms-header"><span class="score-label" style="color:var(--text-primary);font-weight:700;">' + (m.summary.title || '今日用药') + '</span></div>' +
  ...
  function renderMetrics() {
    ...
    // Device sync shortcut
    html += '<div class="rm-device-sync-bar" onclick="switchScreen(\'device-sync\')">' +
      '<div class="rm-ds-icon"><svg viewBox="0 0 24 24" fill="none" stroke="#3D8A5A" stroke-width="2" stroke-linecap="round"><path d="M18 8h1a2 2 0 012 2v4a2 2 0 01-2 2h-1M6 8H5a2 2 0 00-2 2v4a2 2 0 002 2h1M12 12h.01"/></svg></div>' +
      '<div class="rm-ds-text"><div class="rm-ds-title">从智能设备同步</div><div class="rm-ds-desc">手表、体脂秤、血糖仪、微信运动</div></div>' +
      '<span class="menu-arrow">' + SVG.chevron + '</span></div>';

    // Current metrics dashboard grid
    html += '<div class="section-label">' + m.currentLabel + '</div>';
    if (m.metrics && m.metrics.length) {
      html += '<div class="metric-dashboard-grid">';
      m.metrics.forEach(function(mc) {
        var meta = METRIC_CARD_META[mc.label === '血压' ? 'blood_pressure' : Object.keys(METRIC_CARD_META).find(function(k) { return METRIC_CARD_META[k].label === mc.label; })] || {};
        var icon = meta.icon || '';
        var iconBg = meta.iconBg || 'rgba(61,138,90,.1)';
        var iconStroke = meta.iconStroke || 'var(--primary)';
        html += '<div class="metric-dashboard-card" onclick="switchScreen(\'record-metric\')">' +
          '<div class="mcd-top"><div class="mcd-icon" style="background:' + iconBg + '">' +
          '<svg viewBox="0 0 24 24" fill="none" stroke="' + iconStroke + '" stroke-width="2" stroke-linecap="round">' + icon + '</svg></div></div>' +
          '<div class="mcd-label">' + mc.label + '</div>' +
          '<div class="mcd-value-row"><span class="mcd-value">' + mc.value + '</span><span class="mcd-unit">' + mc.unit + '</span></div></div>';
      });
      html += '</div>';
    } else {
      html += '<div class="metric-dashboard-empty">' +
        '<div class="mcd-empty-title">暂无指标记录</div>' +
        '<div class="mcd-empty-desc">记录第一条健康指标，开始追踪家人健康</div>' +
        '<button class="btn-secondary" style="margin-top:12px;" onclick="switchScreen(\'record-metric\')">去记录</button>' +
        '</div>';
    }

    // Trend chart (keep for blood pressure)
    var t = m.trend;
    if (t && t.systolic && t.systolic.points) {
  ...
  function renderMemberDetail() {
    ...
    var currentId = window.currentMemberId;
    var m = members[0];
    for (var i = 0; i < members.length; i++) {
      if (members[i].id === currentId) { m = members[i]; break; }
    }
    var headerActions = '<div style="display:flex;gap:8px;">' +
      '<button class="header-btn" onclick="openMemberEdit(\'' + m.id + '\')">编辑</button>' +
      '<button class="header-btn" onclick="deleteMember(\'' + m.id + '\')" style="background:var(--error)">删除</button>' +
      '</div>';
    var html = pageHeader(D.memberDetail.pageTitle, true, headerActions);
    ...
    // Recent metrics dashboard (Huawei Health style grid)
    html += '<div class="section-label" style="display:flex;align-items:center;justify-content:space-between;">' +
      '<span>最近指标</span>' +
      '<span class="header-btn" style="padding:5px 10px;font-size:11px;" onclick="switchScreen(\'record-metric\')">+ 记录</span></div>';
    if (m.metrics && m.metrics.length) {
      html += '<div class="metric-dashboard-grid">';
      m.metrics.forEach(function(mc) {
        var trendIcon = mc.trend === 'up' ? '↑' : (mc.trend === 'down' ? '↓' : '–');
        var trendClass = mc.trend === 'up' ? 'up' : (mc.trend === 'down' ? 'down' : 'flat');
        var statusDot = mc.status !== 'normal' ? '<span class="mcd-dot warn"></span>' : '<span class="mcd-dot"></span>';
        var timeStr = mc.recordedAt ? formatMetricTime(mc.recordedAt) : '';
        html += '<div class="metric-dashboard-card" onclick="openMetricHistory(\'' + mc.type + '\')">' +
          '<div class="mcd-top">' +
          '<div class="mcd-icon" style="background:' + mc.iconBg + '">' +
          '<svg viewBox="0 0 24 24" fill="none" stroke="' + mc.iconStroke + '" stroke-width="2" stroke-linecap="round">' + mc.icon + '</svg></div>' +
          statusDot + '</div>' +
          '<div class="mcd-label">' + mc.label + '</div>' +
          '<div class="mcd-value-row"><span class="mcd-value">' + mc.value + '</span><span class="mcd-unit">' + mc.unit + '</span></div>' +
          '<div class="mcd-meta">' +
          '<span class="mcd-trend ' + trendClass + '">' + trendIcon + ' ' + Math.abs(mc.trendPct || 0) + '%</span>' +
          '<span class="mcd-time">' + timeStr + '</span></div></div>';
      });
      html += '</div>';
    } else {
      html += '<div class="metric-dashboard-empty">' +
        '<div class="mcd-empty-title">暂无指标记录</div>' +
        '<div class="mcd-empty-desc">点击下方「记录指标」或连接智能设备同步数据</div>' +
        '<button class="btn-secondary" style="margin-top:12px;" onclick="switchScreen(\'record-metric\')">记录第一条指标</button>' +
        '<button class="btn-secondary" style="margin-top:10px;" onclick="switchScreen(\'device-sync\')">连接设备</button>' +
        '</div>';
    }
  ...
  function openMetricHistory(type) {
    window.currentMetricType = type;
    window.currentMetricMemberId = window.currentMemberId;
    switchScreen('metric-history');
  }

  /* ========================================
     SCREEN 9: Metric History
     ======================================== */
  function renderMetricHistory() {
    var memberId = window.currentMetricMemberId;
    var type = window.currentMetricType;
    var members = (D.memberDetail && Array.isArray(D.memberDetail.members)) ? D.memberDetail.members : [];
    var member = members.find(function(m) { return m.id === memberId; }) || members[0] || { name: '成员', metrics: [] };
    var meta = METRIC_CARD_META[type] || { label: METRIC_LABELS[type] || type, unit: '', icon: '', iconBg: '', iconStroke: '' };

    var html = pageHeader(meta.label + ' · ' + member.name, true);

    // 尝试从已缓存的成员指标卡片找到 summary；否则显示加载
    var summary = null;
    var cachedCard = (member.metrics || []).find(function(c) { return c.type === type; });
    if (cachedCard) {
      summary = { latest: cachedCard.value, unit: cachedCard.unit, recordedAt: cachedCard.recordedAt };
    }

    html += '<div id="mh-loading" class="metric-history-loading">加载中…</div>';
    html += '<div id="mh-content" style="display:none;">';

    // 最新值大卡片
    html += '<div class="metric-dashboard-card" style="width:100%;margin-bottom:var(--space-lg);">' +
      '<div class="mcd-top">' +
      '<div class="mcd-icon" style="background:' + meta.iconBg + '">' +
      '<svg viewBox="0 0 24 24" fill="none" stroke="' + meta.iconStroke + '" stroke-width="2" stroke-linecap="round">' + meta.icon + '</svg></div></div>' +
      '<div class="mcd-label">' + meta.label + '</div>' +
      '<div class="mcd-value-row"><span class="mcd-value" id="mh-latest-value">' + (summary ? summary.latest : '--') + '</span><span class="mcd-unit" id="mh-latest-unit">' + (summary ? summary.unit : meta.unit) + '</span></div>' +
      '<div class="mcd-meta"><span class="mcd-time" id="mh-latest-time">' + (summary ? formatMetricTime(summary.recordedAt) : '') + '</span></div></div>';

    // 趋势图占位
    html += '<div class="section-label">近 7 次趋势</div>';
    html += '<div class="trend-chart-card"><div class="chart-area">' +
      '<svg id="mh-chart" class="chart-svg" viewBox="0 0 330 100" preserveAspectRatio="none"></svg></div></div>';

    // 记录列表
    html += '<div class="section-label">历史记录</div>';
    html += '<div id="mh-list" class="records-card"></div>';

    // 操作按钮
    html += '<button class="continue-btn" style="margin-top:var(--space-lg);" onclick="switchScreen(\'record-metric\')">记一笔</button>';
    html += '<button class="btn-secondary" style="margin-top:var(--space-md);margin-bottom:var(--space-xl);" onclick="switchScreen(\'device-sync\')">从设备同步</button>';

    html += '</div>';

    document.getElementById('content-metric-history').innerHTML = html;

    // 异步加载趋势与列表
    loadMetricHistoryData(memberId, type, meta);
  }

  function loadMetricHistoryData(memberId, type, meta) {
    var apiType = type === 'blood_pressure' ? 'blood_pressure_systolic' : type;
    Promise.all([
      window.API.getMetrics(memberId, apiType, 30),
      window.API.getMetricTrend(memberId, apiType, 30)
    ]).then(function(res) {
      var rows = res[0] || [];
      var trend = res[1] || {};
      var listEl = document.getElementById('mh-list');
      var chartEl = document.getElementById('mh-chart');
      var latestValEl = document.getElementById('mh-latest-value');
      var latestUnitEl = document.getElementById('mh-latest-unit');
      var latestTimeEl = document.getElementById('mh-latest-time');

      document.getElementById('mh-loading').style.display = 'none';
      document.getElementById('mh-content').style.display = 'block';

      if (rows.length && latestValEl) {
        var latest = rows[0];
        latestValEl.textContent = formatMetricDisplayValue(type, latest.value);
        latestUnitEl.textContent = latest.unit || meta.unit;
        latestTimeEl.textContent = formatMetricTime(latest.recordedAt);
      }

      // 列表
      if (listEl) {
        listEl.innerHTML = rows.length ? rows.slice(0, 20).map(function(r) {
          var statusClass = r.status === 'normal' ? '' : (r.status === 'high' ? 'warn' : 'low');
          return '<div class="record-item">' +
            '<div class="record-text"><span class="record-value">' + r.value + '</span> <span class="record-unit ' + statusClass + '">' + (r.unit || meta.unit) + '</span></div>' +
            '<span class="record-time">' + formatMetricTime(r.recordedAt) + '</span></div>';
        }).join('') : '<div class="md-empty">暂无记录</div>';
      }

      // 趋势图
      if (chartEl && trend.series && trend.series.length) {
        drawMetricChart(chartEl, trend.series, type);
      } else if (chartEl) {
        chartEl.innerHTML = '<text x="165" y="55" text-anchor="middle" fill="var(--text-tertiary)" font-size="12">暂无足够数据绘制趋势</text>';
      }
    }).catch(function(e) {
      console.warn('[metricHistory] 加载失败', e);
      var loading = document.getElementById('mh-loading');
      if (loading) loading.textContent = '加载失败，请检查网络';
    });
  }

  function formatMetricDisplayValue(type, value) {
    if (type === 'blood_pressure') return value; // 已格式化为 sys/dia
    if (typeof value === 'number') return Number(value.toFixed(2));
    return value;
  }

  function drawMetricChart(svgEl, series, type) {
    var values = series.map(function(s) { return s.value; });
    var min = values.reduce(function(a, b) { return Math.min(a, b); }, values[0]);
    var max = values.reduce(function(a, b) { return Math.max(a, b); }, values[0]);
    var pad = (max - min) || 1;
    var n = series.length;
    var points = series.map(function(s, i) {
      var x = n === 1 ? 165 : (i / (n - 1)) * 300 + 15;
      var y = 90 - ((s.value - min) / pad) * 70;
      return Math.round(x) + ',' + Math.round(y);
    }).join(' ');
    var color = (METRIC_CARD_META[type] || {}).iconStroke || 'var(--primary)';
    var circles = series.map(function(s, i) {
      var xy = points.split(' ')[i].split(',');
      return '<circle cx="' + xy[0] + '" cy="' + xy[1] + '" r="3" fill="' + color + '"/>';
    }).join('');
    svgEl.innerHTML =
      '<line x1="0" y1="20" x2="330" y2="20" stroke="#f0efe9" stroke-width="1"/>' +
      '<line x1="0" y1="55" x2="330" y2="55" stroke="#f0efe9" stroke-width="1"/>' +
      '<line x1="0" y1="90" x2="330" y2="90" stroke="#f0efe9" stroke-width="1"/>' +
      '<polyline points="' + points + '" fill="none" stroke="' + color + '" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>' +
      circles;
  }

  /* ========================================
     SCREEN 9b: Device Sync
     ======================================== */
  function renderDeviceSync() {
    var html = pageHeader('设备数据同步', true);

    html += '<div class="device-sync-intro">' +
      '<div class="dsi-title">智能设备一键同步</div>' +
      '<div class="dsi-desc">连接手表、体脂秤、血糖仪等设备，自动同步步数、心率、睡眠、体脂等数据</div></div>';

    var devices = [
      { key: 'watch', name: '智能手表 / 手环', desc: '同步步数、心率、血氧、睡眠、压力', icon: '<path d="M18 8h1a2 2 0 012 2v4a2 2 0 01-2 2h-1M6 8H5a2 2 0 00-2 2v4a2 2 0 002 2h1M12 12h.01"/>', iconBg: 'rgba(80,160,220,.12)', iconStroke: '#50A0DC', connected: false },
      { key: 'scale', name: '智能体脂秤', desc: '同步体重、BMI、体脂率', icon: '<rect x="3" y="8" width="18" height="8" rx="4"/>', iconBg: 'rgba(216,149,117,.12)', iconStroke: '#D89575', connected: false },
      { key: 'glucose', name: '血糖仪', desc: '同步空腹/餐后血糖', icon: '<circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 2"/>', iconBg: 'rgba(212,166,74,.12)', iconStroke: '#D4A64A', connected: false },
      { key: 'bp', name: '血压计', desc: '同步收缩压/舒张压', icon: '<path d="M3 12h4l3-8 4 16 3-8h4"/>', iconBg: 'rgba(208,128,104,.12)', iconStroke: '#D08068', connected: false },
      { key: 'werun', name: '微信运动', desc: '通过小程序 getWeRunData 同步步数', icon: '<path d="M12 21c5.5 0 10-4.5 10-10S17.5 1 12 1 2 5.5 2 11s4.5 10 10 10z"/><path d="M8 11l4 4 5-7"/>', iconBg: 'rgba(61,138,90,.12)', iconStroke: '#3D8A5A', connected: false },
    ];

    html += '<div class="device-list">';
    devices.forEach(function(d) {
      html += '<div class="device-card" data-device="' + d.key + '">' +
        '<div class="device-icon" style="background:' + d.iconBg + '">' +
        '<svg viewBox="0 0 24 24" fill="none" stroke="' + d.iconStroke + '" stroke-width="2" stroke-linecap="round">' + d.icon + '</svg></div>' +
        '<div class="device-info">' +
        '<div class="device-name">' + d.name + '</div>' +
        '<div class="device-desc">' + d.desc + '</div></div>' +
        '<button class="device-action ' + (d.connected ? 'connected' : '') + '" onclick="toggleDeviceSync(\'' + d.key + '\')">' + (d.connected ? '已连接' : '连接') + '</button></div>';
    });
    html += '</div>';

    html += '<div class="device-sync-note">' +
      '<div class="dsn-title">后续扩展计划</div>' +
      '<ul>' +
      '<li>微信小程序：调用 <code>wx.getWeRunData</code> 获取微信运动步数</li>' +
      '<li>蓝牙 BLE：搜索附近设备并读取 GATT 特征值</li>' +
      '<li>厂商 SDK：华为运动健康、小米运动等 OAuth 授权同步</li>' +
      '</ul></div>';

    document.getElementById('content-device-sync').innerHTML = html;
  }

  function toggleDeviceSync(deviceKey) {
    // 当前阶段为占位实现：模拟连接流程
    showToast('正在连接 ' + deviceKey + '…');
    setTimeout(function() {
      showToast(deviceKey + ' 连接成功（演示）');
    }, 1200);
  }

  /* ========================================
     SCREEN 9c: Assess Report
     ======================================== */
  ...
  function completeAssessReport() {
    showToast('报告已保存');
    // 刷新自评历史与首页/我的页统计
    window.syncFromBackend().then(function() {
      renderHome();
      renderProfile();
  ...
  /* ========================================
     SCREEN 9b: Health Assessment History
     ======================================== */
  var assessHistoryCache = { items: [], total: 0, loaded: false };
  var assessHistorySelectedId = null;
  var assessHistorySelectedMemberId = null;

  async function renderAssessHistory() {
    var title = '健康自评记录';
    var html = pageHeader(title, true);

    html += '<div class="section-label" style="margin-top:var(--space-md);">成员</div>';
    html += '<div class="tag-group" id="assess-history-member-filter">' +
      (window.activeMembers || []).map(function(m, i) {
        var selected = (i === 0) ? ' selected' : '';
        return '<span class="tag-pill' + selected + '" data-member-id="' + (m.id || '') + '" onclick="selectAssessHistoryMember(this)">' + escapeHtml(m.nickname || '成员') + '</span>';
      }).join('') + '</div>';

    html += '<div class="section-label">历史记录</div>';
    html += '<div id="assess-history-list" class="records-card">' +
      '<div class="record-item" style="justify-content:center;color:var(--text-secondary);">加载中…</div></div>';

    html += '<div class="btn-row" style="margin-top:var(--space-xl);">' +
      '<button class="continue-btn" onclick="switchScreen(\'assess\')">开始新自评</button></div>';

    document.getElementById('content-assess-history').innerHTML = html;

    var firstMember = (window.activeMembers || [])[0];
    if (firstMember) {
      assessHistorySelectedMemberId = firstMember.id;
      loadAssessHistory(firstMember.id);
    } else {
      document.getElementById('assess-history-list').innerHTML =
        '<div class="record-item" style="justify-content:center;color:var(--text-secondary);">暂无家庭成员</div>';
    }
  }

  function selectAssessHistoryMember(el) {
    var group = document.getElementById('assess-history-member-filter');
    if (group) {
      group.querySelectorAll('.tag-pill.selected').forEach(function(s) { s.classList.remove('selected'); });
    }
    el.classList.add('selected');
    assessHistorySelectedMemberId = el.dataset.memberId;
    loadAssessHistory(assessHistorySelectedMemberId);
  }

  async function loadAssessHistory(memberId) {
    var listEl = document.getElementById('assess-history-list');
    if (!listEl) return;
    listEl.innerHTML = '<div class="record-item" style="justify-content:center;color:var(--text-secondary);">加载中…</div>';
    try {
      var res = await window.API.getAssessHistory(memberId);
      var items = (res && res.items) || [];
      assessHistoryCache.items = items;
      assessHistoryCache.loaded = true;
      if (!items.length) {
        listEl.innerHTML = '<div class="record-item" style="justify-content:center;color:var(--text-secondary);">暂无自评记录</div>';
        return;
      }
      listEl.innerHTML = items.map(function(item, i) {
        var score = Number(item.totalScore) || 0;
        var level = score >= 8 ? '良好' : score >= 6 ? '一般' : '需关注';
        var date = item.completedAt ? formatDate(item.completedAt) : '未知时间';
        return '<div class="record-item" onclick="openAssessHistoryDetail(' + i + ')" style="cursor:pointer;">' +
          '<span class="record-text">自评得分 <strong>' + score.toFixed(1) + '</strong> 分（' + level + '）</span>' +
          '<span class="record-time">' + date + '</span></div>';
      }).join('');
    } catch (e) {
      console.error('[assessHistory] 加载失败', e);
      listEl.innerHTML = '<div class="record-item" style="justify-content:center;color:var(--text-secondary);">加载失败</div>';
    }
  }
  ...
  function openAssessHistoryDetail(idx) {
    var item = assessHistoryCache.items[idx];
    if (!item) return;
    assessHistorySelectedId = item.id;
    switchScreen('assess-history-detail');
  }

  async function renderAssessHistoryDetail() {
    var html = pageHeader('自评详情', true);
    if (!assessHistorySelectedId) {
      html += '<div class="md-empty">未选择记录</div>';
      document.getElementById('content-assess-history-detail').innerHTML = html;
      return;
    }
    html += '<div class="md-empty">加载中…</div>';
    document.getElementById('content-assess-history-detail').innerHTML = html;
    try {
      var detail = await window.API.getAssessResult(assessHistorySelectedId);
      var score = Number(detail.totalScore) || 0;
      var level = score >= 8 ? '良好' : score >= 6 ? '一般' : '需关注';
      var dims = Array.isArray(detail.radarChart) ? detail.radarChart
        : (detail.categoryScores ? Object.keys(detail.categoryScores).map(function(k) { return { category: k, score: detail.categoryScores[k] }; }) : []);
      var concerns = Array.isArray(detail.topConcerns) ? detail.topConcerns : [];

      html = pageHeader('自评详情', true);
      html += '<div class="ar-score-card">' +
        '<div class="ar-score-circle">' +
        '<div class="ar-score-val">' + score.toFixed(1) + '</div>' +
        '<div class="ar-score-unit">分</div></div>' +
        '<div class="ar-grade-badge">' + level + '</div>' +
        '<div class="ar-summary">' + (detail.fullAnalysis ? detail.fullAnalysis.replace(/[#>*`]/g, '').split('\n').filter(Boolean).slice(0, 2).join(' ') : '') + '</div></div>';
      ...
      dims.forEach(function(d) {
        ...
        html += '<div class="dimension-bar">' +
          '<div class="dim-header"><span class="dim-label">' + d.category + '</span>' +
          '<span class="dim-score ' + scoreLevel(s) + '">' + s.toFixed(1) + '</span></div>' +
          '<div class="dim-track"><div class="dim-fill ' + scoreLevel(s) + '" style="width:' + (s * 10) + '%"></div></div></div>';
      });
      html += '</div>';

      html += '<div class="section-label">风险提示</div>';
      html += '<div class="ar-risk-card">' +
        '<div class="ar-risk-title">温馨提示</div>';
      if (concerns.length) {
        concerns.forEach(function(c) {
          html += '<div class="ar-risk-item">' + c.category + '：' + c.suggestion + '</div>';
        });
      } else {
        html += '<div class="ar-risk-item">暂无显著风险，继续保持健康习惯。</div>';
      }
      html += '</div>';

      html += '<div class="btn-row" style="margin-top:var(--space-xl);">' +
        '<button class="continue-btn" onclick="goBack()">返回</button></div>';
      document.getElementById('content-assess-history-detail').innerHTML = html;
    } catch (e) {
      console.error('[assessHistoryDetail] 加载失败', e);
      document.getElementById('content-assess-history-detail').innerHTML =
        pageHeader('自评详情', true) + '<div class="md-empty">加载失败，请稍后重试</div>';
    }
  }
  ...
  function renderAddMember() {
    ...
    html += '<div class="form-field">' +
      ...
      '<input class="form-input" type="text" placeholder="请输入成员姓名" /></div>';
    ...
    html += '<div class="form-field">' +
      ...
      '<div class="tag-group" id="add-member-health-tags" data-multi="true">' +
      a.healthConditions.map(function(c) {
        return '<span class="tag-pill" onclick="selectTag(this)">' + c + '</span>';
      }).join('') + '</div>' +
      '<div class="custom-tag-input" style="display:flex;gap:8px;margin-top:12px;">' +
      '<input class="form-input" type="text" id="add-member-custom-disease" placeholder="输入其他疾病，按回车添加" style="flex:1;" onkeydown="if(event.key===\'Enter\') addCustomDiseaseTag(\'add-member-health-tags\',\'add-member-custom-disease\')"/>' +
      '<button class="header-btn" type="button" onclick="addCustomDiseaseTag(\'add-member-health-tags\',\'add-member-custom-disease\')">添加</button>' +
      '</div></div>';

    html += '<div class="form-field">' +
      '<label class="form-label">紧急联系人（选填）</label>' +
      '<input class="form-input" type="text" placeholder="请输入联系人姓名和电话" /></div>';
  ...
  function saveAddMember() {
    var form = document.getElementById('content-add-member');
    var inputs = form.querySelectorAll('.form-input');
    var name = inputs[0] ? inputs[0].value.trim() : '';
    var birthday = inputs[1] ? inputs[1].value : '';
    var emergency = inputs[2] ? inputs[2].value.trim() : '';

    if (!name) { showToast('请输入成员姓名'); return; }

    var relationMap = { '爸爸': 'parent', '妈妈': 'parent', '配偶': 'spouse', '儿子': 'child', '女儿': 'child', '其他': 'other' };
    var genderMap = { '男': 1, '女': 2 };

    var relation = form.querySelectorAll('.tag-group')[0].querySelector('.tag-pill.selected');
    var gender = form.querySelectorAll('.tag-group')[1].querySelector('.tag-pill.selected');
    ...
    var payload = {
      nickname: name,
      relation: relationMap[relation && relation.textContent] || 'other',
      gender: genderMap[gender && gender.textContent] || 0,
      age: age,
    };

    var familyId = window.activeFamilyId;
    if (!familyId) { showToast('家庭信息未加载，请刷新页面'); return; }

    var btn = form.querySelector('.continue-btn');
    if (btn) { btn.disabled = true; btn.textContent = '保存中…'; }

    window.API.createMember(familyId, payload).then(function(member) {
      showToast('成员添加成功');
      // 保存健康状况（慢病史）
      var conditions = collectSelectedHealthTags('add-member-health-tags');
      var savePromise = Promise.resolve();
      if (member && member.id && conditions.length) {
        savePromise = window.API.updateChronicDiseases(member.id, conditions).catch(function(e) {
          console.warn('[addMember] 保存疾病标签失败', e);
        });
      }
      // 立即更新本地缓存，避免依赖 syncFromBackend 后再刷新
      if (member && member.id) {
        if (!window.activeMembers) window.activeMembers = [];
        window.activeMembers.push(member);
        D.addMed.members = window.activeMembers.map(function(m) { return { id: m.id, name: m.nickname || '成员' }; });
        D.recordMetric.measurers = window.activeMembers.map(function(m) { return m.nickname || '成员'; });
      }
      return savePromise.then(function() {
        return window.syncFromBackend().then(function() {
          // 添加成功后同步所有依赖家庭成员的页面，确保任何位置都立即回显新成员
          renderHome();
          renderArchive();
          renderMemberDetail();
          renderMeds();
          ...
          renderRecordMetric();
          renderProfile();
          // 添加成功后直接回到家庭档案页，回显新成员
          goBack();
        });
      });
    }).catch(function(e) {
      console.error('[addMember] 添加成员失败', e);
      showToast('添加失败：' + (e && e.message ? e.message : '网络错误'));
      if (btn) { btn.disabled = false; btn.textContent = '保存成员'; }
    });
  }

  /* ========================================
     Member Edit / Delete helpers
     ======================================== */
  function openMemberEdit(id) {
    window.editingMemberId = id;
    switchScreen('edit-member');
  }

  function renderEditMember() {
    var currentId = window.editingMemberId;
    var members = window.activeMembers || [];
    var member = null;
    for (var i = 0; i < members.length; i++) {
      if (members[i].id === currentId) { member = members[i]; break; }
    }
    if (!member) {
      document.getElementById('content-edit-member').innerHTML =
        pageHeader('编辑成员', true) + '<div class="md-empty">成员不存在</div>';
      return;
    }
    window.editingMemberId = member.id;

    var relationLabelMap = { parent: member.gender === 2 ? '妈妈' : '爸爸', spouse: '配偶', child: member.gender === 2 ? '女儿' : '儿子', self: '本人', other: '其他' };
    var genderMap = { 1: '男', 2: '女' };

    var birthday = '';
    if (member.age) {
      var d = new Date();
      d.setFullYear(d.getFullYear() - member.age);
    ...
    try {
      ...
      var rawList = JSON.parse(hr.chronicDiseases || '[]');
      selectedConditions = rawList.map(function(x) { return typeof x === 'string' ? x : (x && x.name ? x.name : ''); }).filter(Boolean);
    } catch(e) {}

    var html = pageHeader('编辑成员', true);

    html += '<div class="form-field">' +
      '<label class="form-label">姓名<span class="form-required">*</span></label>' +
      '<input class="form-input" type="text" value="' + escapeHtml(member.nickname || '') + '" /></div>';

    html += '<div class="form-field">' +
      '<label class="form-label">关系<span class="form-required">*</span></label>' +
      '<div class="tag-group">' +
      D.addMember.relations.map(function(r) {
        var selected = r === (relationLabelMap[member.relation] || '其他') ? ' selected' : '';
        return '<span class="tag-pill' + selected + '" onclick="selectTag(this)">' + r + '</span>';
      }).join('') + '</div></div>';

    html += '<div class="form-field">' +
      '<label class="form-label">性别<span class="form-required">*</span></label>' +
      '<div class="tag-group">' +
      D.addMember.genders.map(function(g) {
        var selected = g === (genderMap[member.gender] || '') ? ' selected' : '';
        return '<span class="tag-pill' + selected + '" onclick="selectTag(this)">' + g + '</span>';
      }).join('') + '</div></div>';

    html += '<div class="form-field">' +
      '<label class="form-label">出生日期</label>' +
      '<input class="form-input" type="date" value="' + birthday + '" /></div>';

    html += '<div class="form-field">' +
      '<label class="form-label">健康状况</label>' +
      '<div class="tag-group" id="edit-member-health-tags" data-multi="true">' +
      D.addMember.healthConditions.map(function(c) {
        var selected = selectedConditions.indexOf(c) >= 0 ? ' selected' : '';
        return '<span class="tag-pill' + selected + '" onclick="selectTag(this)">' + c + '</span>';
      }).join('');
    // 追加自定义疾病标签（不在固定选项中）
    selectedConditions.forEach(function(c) {
      if (D.addMember.healthConditions.indexOf(c) < 0) {
        html += '<span class="tag-pill selected" onclick="selectTag(this)">' + escapeHtml(c) + '</span>';
      }
    });
    html += '</div>' +
      '<div class="custom-tag-input" style="display:flex;gap:8px;margin-top:12px;">' +
      '<input class="form-input" type="text" id="edit-member-custom-disease" placeholder="输入其他疾病，按回车添加" style="flex:1;" onkeydown="if(event.key===\'Enter\') addCustomDiseaseTag(\'edit-member-health-tags\',\'edit-member-custom-disease\')"/>' +
      '<button class="header-btn" type="button" onclick="addCustomDiseaseTag(\'edit-member-health-tags\',\'edit-member-custom-disease\')">添加</button>' +
      '</div></div>';

    html += '<button class="continue-btn" onclick="saveEditMember()">保存修改</button>' +
      '<button class="btn-secondary" onclick="goBack()" style="margin-top:12px;width:100%;">取消</button>';

    document.getElementById('content-edit-member').innerHTML = html;
  }

  function saveEditMember() {
    var form = document.getElementById('content-edit-member');
    var inputs = form.querySelectorAll('.form-input');
    var name = inputs[0] ? inputs[0].value.trim() : '';
    var birthday = inputs[1] ? inputs[1].value : '';
    ...
    var relation = form.querySelectorAll('.tag-group')[0].querySelector('.tag-pill.selected');
    var gender = form.querySelectorAll('.tag-group')[1].querySelector('.tag-pill.selected');
    var healthTags = form.querySelectorAll('.tag-group')[2].querySelectorAll('.tag-pill.selected');
    ...
    var conditions = Array.prototype.map.call(healthTags, function(t) { return t.textContent; }).filter(function(c) { return c !== '无慢性病'; });
    if (conditions.length) {
      payload.chronicDiseases = JSON.stringify(conditions);
    }

    var familyId = window.activeFamilyId;
    var memberId = window.editingMemberId;
    if (!familyId || !memberId) { showToast('成员信息不完整'); return; }

    var btn = form.querySelector('.continue-btn');
    if (btn) { btn.disabled = true; btn.textContent = '保存中…'; }

    window.API.updateMember(familyId, memberId, payload).then(function() {
      showToast('成员修改成功');
      var conditions = collectSelectedHealthTags('edit-member-health-tags');
      return window.API.updateChronicDiseases(memberId, conditions).catch(function(e) {
        console.warn('[editMember] 保存疾病标签失败', e);
      }).then(function() {
        return window.syncFromBackend().then(function() {
          renderHome();
          renderArchive();
      ...
      console.error('[editMember] 修改成员失败', e);
      showToast('修改失败：' + (e && e.message ? e.message : '网络错误'));
  ...
  function deleteMember(id) {
    ...
    if (!member) { showToast('成员不存在'); return; }

    if (!window.confirm('确定删除成员「' + (member.nickname || '成员') + '」吗？相关健康记录将无法恢复。')) {
      return;
    }

    var familyId = window.activeFamilyId;
    if (!familyId) { showToast('家庭信息未加载'); return; }

    window.API.removeMember(familyId, member.id).then(function() {
      showToast('成员已删除');
      // 如果删除的是当前 AI 咨询选中的成员，重置为第一个可用成员
      if (window.activeConsultMemberId === member.id) {
        var remaining = members.filter(function(m) { return m.id !== member.id; });
        window.activeConsultMemberId = remaining.length ? remaining[0].id : null;
      }
      return window.syncFromBackend().then(function() {
        renderHome();
        renderArchive();
        ...
        renderAddMed();
        renderRecordMetric();
        renderConsult(); // 同步刷新 AI 咨询页成员选择器
        renderProfile();
        switchScreen('archive', false);
      });
    }).catch(function(e) {
      console.error('[deleteMember] 删除成员失败', e);
      showToast('删除失败：' + (e && e.message ? e.message : '网络错误'));
    });
  }
  ...
  function renderAddMed() {
    ...
    if (a.members && a.members.length) {
      html += '<div class="tag-group" id="add-med-member-group">' +
        a.members.map(function(m, i) {
          var name = typeof m === 'string' ? m : (m.name || m.nickname || '未知');
          var id = typeof m === 'string' ? m : (m.id || '');
          return '<span class="tag-pill' + (i === 0 ? ' selected' : '') + '" data-member-id="' + escapeHtml(String(id)) + '" onclick="selectTag(this)">' + escapeHtml(name) + '</span>';
        }).join('') + '</div>';
    } else {
      html += '<div class="empty-state" style="margin:var(--space-md) 0;">暂无家庭成员，请先去添加成员</div>' +
        '<button class="continue-btn" style="margin-top:var(--space-md);" onclick="switchScreen(\'add-member\')">去添加成员</button>';
    }
    html += '</div>';

    html += '<div class="form-field">' +
      '<label class="form-label">药品名称<span class="form-required">*</span></label>' +
      '<input class="form-input" type="text" placeholder="请输入药品名称" /></div>';

    html += '<div class="form-field">' +
      '<label class="form-label">剂量<span class="form-required">*</span></label>' +
      '<input class="form-input" type="text" placeholder="如：80mg / 1片" /></div>';
    ...
    html += '<div class="form-field">' +
      ...
      '<input class="form-input" type="time" value="08:00" /></div>';
    ...
    html += '<div class="form-field">' +
      ...
      '<textarea class="form-textarea" placeholder="如：饭后半小时服用，避免与牛奶同服"></textarea></div>';
  ...
  function saveAddMed() {
    var form = document.getElementById('content-add-med');
    var inputs = form.querySelectorAll('.form-input, .form-textarea');
    var medicineName = inputs[0] ? inputs[0].value.trim() : '';
    var dosage = inputs[1] ? inputs[1].value.trim() : '';
    var time = inputs[2] ? inputs[2].value : '08:00';
    var notes = inputs[3] ? inputs[3].value.trim() : '';

    if (!medicineName) { showToast('请输入药品名称'); return; }

    var groups = form.querySelectorAll('.tag-group');
    var memberTag = groups[0] && groups[0].querySelector('.tag-pill.selected');
    var freqTag = groups[1] && groups[1].querySelector('.tag-pill.selected');
    var methodTag = groups[2] && groups[2].querySelector('.tag-pill.selected');

    var memberId = memberTag ? memberTag.dataset.memberId : '';
    if (!memberId) { showToast('请选择用药人'); return; }

    var freqMap = { '每日一次': 'daily', '每日两次': 'twice_daily', '每日三次': 'three_times', '按需服用': 'custom' };
    var frequency = freqMap[freqTag && freqTag.textContent] || 'daily';

    var method = methodTag ? methodTag.textContent : '';
    var fullNotes = method ? ('服用方式：' + method + (notes ? '；' + notes : '')) : notes;
    ...
    if (frequency === 'custom') {
      payload.customSchedule = [{ time: time, dosage: dosage || undefined, note: notes || undefined }];
    }

    var btn = form.querySelector('.continue-btn');
    if (btn) { btn.disabled = true; btn.textContent = '保存中…'; }

    window.API.createMedication(payload).then(function(plan) {
      showToast('用药提醒已添加');
      return window.syncFromBackend().then(function() {
        renderMeds();
        goBack();
      ...
      console.error('[addMed] 添加用药失败', e);
      showToast('添加失败：' + (e && e.message ? e.message : '网络错误'));
      if (btn) { btn.disabled = false; btn.textContent = '保存用药提醒'; }
    });
  }
  ...
  function renderRecordMetric() {
    ...
    var members = window.activeMembers || [];
    if (!members.length) {
      html += '<div class="form-field"><div class="empty-state">暂无家庭成员，请先添加成员后再记录指标</div></div>';
    ...
    // Member selector
    html += '<div class="form-field">' +
      '<label class="form-label">选择成员<span class="form-required">*</span></label>' +
      '<div class="tag-group" id="record-metric-member-group">' +
      members.map(function(m, i) {
        return '<span class="tag-pill' + (i === 0 ? ' selected' : '') + '" data-member-id="' + escapeHtml(String(m.id || '')) + '" onclick="selectTag(this)">' + escapeHtml(m.nickname || '成员') + '</span>';
      }).join('') + '</div></div>';

    // Metric type selector (horizontal scroll)
    ...
    html += '<div class="form-field">' +
      ...
      '<input id="rm-recorded-at" class="form-input" type="datetime-local" /></div>';

    // Notes
    html += '<div class="form-field">' +
      '<label class="form-label">备注（选填）</label>' +
      '<input id="rm-notes" class="form-input" type="text" placeholder="如：运动后测量" /></div>';
  ...
  function renderMetricForm(key) {
    var r = D.recordMetric;
    var type = r.types.find(function(t) { return t.key === key; }) || r.types[0];
    var html = '';

    if (type.inputMode === 'dual') {
      // Blood pressure: dual input
      html += '<div class="rm-bp-row">' +
        '<div class="rm-bp-input"><label class="form-label">收缩压</label>' +
        '<div class="rm-input-with-unit"><input id="rm-bp-sys" class="form-input" type="number" placeholder="120"><span class="rm-unit-suffix">mmHg</span></div></div>' +
        '<span class="rm-bp-sep">/</span>' +
        '<div class="rm-bp-input"><label class="form-label">舒张压</label>' +
        '<div class="rm-input-with-unit"><input id="rm-bp-dia" class="form-input" type="number" placeholder="80"><span class="rm-unit-suffix">mmHg</span></div></div>' +
        '</div>';
    } else if (type.inputMode === 'select') {
      html += '<div class="form-field">' +
        '<label class="form-label">' + type.label + '值</label>' +
        '<div class="rm-input-with-unit"><input id="rm-' + key + '" class="form-input" type="number" placeholder="' + (key === 'glucose' ? '5.6' : '') + '"><span class="rm-unit-suffix">' + type.unit + '</span></div></div>';
      if (key === 'glucose') {
        html += '<div class="form-field">' +
          '<label class="form-label">测量类型</label>' +
          '<div id="rm-glucose-type" class="tag-group">' +
      ...
      // single
      var placeholder = {
        weight: '65.0', bmi: '22.5', body_fat: '22.5', hr: '72', spo2: '98',
        temperature: '36.5', steps: '8000', sleep: '7.5', stress: '45'
      }[key] || '';
      html += '<div class="form-field">' +
        '<label class="form-label">' + type.label + '</label>' +
        '<div class="rm-input-with-unit"><input id="rm-' + key + '" class="form-input" type="number" placeholder="' + placeholder + '"><span class="rm-unit-suffix">' + type.unit + '</span></div></div>';
    }
  ...
  function saveRecordMetric() {
    var form = document.getElementById('content-record-metric');
    if (!form) { showToast('页面未加载'); return; }

    var memberTag = form.querySelector('#record-metric-member-group .tag-pill.selected');
    var memberId = memberTag ? memberTag.dataset.memberId : '';
    if (!memberId) { showToast('请选择成员'); return; }

    var typeKey = window.currentMetricType || 'bp';
    var type = D.recordMetric.types.find(function(t) { return t.key === typeKey; }) || D.recordMetric.types[0];
    var recordedAt = document.getElementById('rm-recorded-at').value;
    var notes = document.getElementById('rm-notes').value.trim();
    var measurerTag = form.querySelector('.tag-group:not(#record-metric-member-group) .tag-pill.selected');
    var measurer = measurerTag ? measurerTag.textContent : '本人';
    var baseNotes = notes ? ('测量人：' + measurer + '；' + notes) : ('测量人：' + measurer);

    var payload;
    if (type.inputMode === 'dual') {
      var sys = Number(document.getElementById('rm-bp-sys').value);
      var dia = Number(document.getElementById('rm-bp-dia').value);
      if (!sys || !dia) { showToast('请填写收缩压和舒张压'); return; }
      payload = {
        memberId: memberId,
        metrics: [
          { metricType: 'blood_pressure_systolic', value: sys, unit: 'mmHg', recordedAt: recordedAt || undefined, notes: baseNotes, inputMethod: 'manual' },
          { metricType: 'blood_pressure_diastolic', value: dia, unit: 'mmHg', recordedAt: recordedAt || undefined, notes: baseNotes, inputMethod: 'manual' },
        ],
      };
    } else {
      var inputId = 'rm-' + typeKey;
      var input = document.getElementById(inputId);
      var value = input ? Number(input.value) : 0;
      if (!value && value !== 0) { showToast('请输入有效的测量值'); return; }
      var metricType = type.metricType;
      var unit = type.unit;
      var extraNotes = baseNotes;
      if (typeKey === 'glucose') {
        var glucoseTypeTag = document.querySelector('#rm-glucose-type .tag-pill.selected');
        var glucoseType = glucoseTypeTag ? glucoseTypeTag.textContent : '空腹';
        metricType = glucoseType.indexOf('空腹') >= 0 ? 'blood_glucose_fasting' : 'blood_glucose_postprandial';
        extraNotes = '测量类型：' + glucoseType + '；' + baseNotes;
      }
      payload = {
        memberId: memberId,
    ...
    var promise = (type.inputMode === 'dual') ? window.API.recordMetricsBatch(payload) : window.API.recordMetric(payload);
    promise.then(function() {
      ...
      console.error('[recordMetric] 保存失败', e);
  ...
  function renderSettings() {
    ...
    s.account.forEach(function(a) {
      if (a.type === 'logout') {
        html += '<button class="btn-secondary danger" onclick="logout()">' + escapeHtml(a.label) + '</button>';
      }
    });
    html += '</div>';
  ...
  /** 收集指定健康状况标签组中，用户选中的疾病（排除“无慢性病”） */
  function collectSelectedHealthTags(groupId) {
    var group = document.getElementById(groupId);
    if (!group) return [];
    return Array.prototype.map.call(group.querySelectorAll('.tag-pill.selected'), function(t) {
      return t.textContent.trim();
    }).filter(function(c) { return c && c !== '无慢性病'; });
  }

  /** 向指定标签组动态添加自定义疾病标签，并自动选中 */
  function addCustomDiseaseTag(groupId, inputId) {
    var input = document.getElementById(inputId);
    if (!input) return;
    ...
    var group = document.getElementById(groupId);
    if (!group) return;
    var existing = Array.prototype.find.call(group.querySelectorAll('.tag-pill'), function(p) {
      return p.textContent.trim() === value;
    });
    if (existing) {
    ...
    tag.className = 'tag-pill selected';
    tag.textContent = value;
    tag.setAttribute('onclick', 'selectTag(this)');
  ...
  function switchScreen(screenKey, pushHistory) {
    ...
    // Screen-specific onEnter handlers：进入数据依赖页面前用最新数据重渲染
    if (targetId === 'screen-home') {
      renderHome();
    } else if (targetId === 'screen-assess') {
      // 进入自评：重置状态并从后端拉取第一步题目（含静态降级）
      renderAssess();
    } else if (targetId === 'screen-assess-report') {
      // 进入报告页前用最新数据重渲染（后端结果或静态降级）
      renderAssessReport();
    } else if (targetId === 'screen-assess-history') {
      renderAssessHistory();
    } else if (targetId === 'screen-assess-history-detail') {
      renderAssessHistoryDetail();
    } else if (targetId === 'screen-archive') {
      renderArchive();
    } else if (targetId === 'screen-meds') {
      renderMeds();
    } else if (targetId === 'screen-metrics') {
      renderMetrics();
    } else if (targetId === 'screen-add-med') {
      renderAddMed();
    } else if (targetId === 'screen-record-metric') {
      renderRecordMetric();
    } else if (targetId === 'screen-metric-history') {
      renderMetricHistory();
    } else if (targetId === 'screen-device-sync') {
      renderDeviceSync();
    } else if (targetId === 'screen-task-edit') {
      renderTaskEditor();
    } else if (targetId === 'screen-consult') {
      // 进入 AI 咨询页时重新渲染，确保成员选择器与最新数据同步
      renderConsult();
    } else if (targetId === 'screen-member-detail') {
      renderMemberDetail();
    } else if (targetId === 'screen-edit-member') {
      renderEditMember();
    }
  }
  ...
  /* ========================================
     Task Toggle
     ======================================== */
  function toggleTaskDone(id, ev) {
    if (ev) ev.stopPropagation();
    var task = (D.home.tasks || []).find(function(t) { return t.id === id; });
    if (!task) return;
    ...
    if (card) {
      ...
      var check = card.querySelector('.task-check');
      if (check) {
        check.classList.toggle('on', newDone);
        check.innerHTML = newDone ? SVG.check : '';
      }
    }
    // 重新统计
    var openCount = (D.home.tasks || []).filter(function(t) { return !t.done; }).length;
    var countEl = document.getElementById('task-count');
    if (countEl) countEl.textContent = openCount + '项待办';
    var statVal = document.getElementById('stat-tasks-val');
    if (statVal) statVal.textContent = openCount + '件';
    if (newDone) showToast('任务已完成');
    // 落库
    window.API.updateTask(id, { done: newDone }).catch(function(e) {
      console.warn('[task] 切换状态失败', e);
      showToast('同步失败，已撤销');
      task.done = !newDone;
      if (card) {
        card.classList.toggle('done', task.done);
        var c2 = card.querySelector('.task-check');
        if (c2) { c2.classList.toggle('on', task.done); c2.innerHTML = task.done ? SVG.check : ''; }
      }
    });
  }

  function deleteTaskItem(id, ev) {
    if (ev) ev.stopPropagation();
    if (!confirm('确定删除这条待办事项？')) return;
    window.API.deleteTask(id).then(function() {
      D.home.tasks = (D.home.tasks || []).filter(function(t) { return t.id !== id; });
      renderHome();
      showToast('已删除');
    }).catch(function(e) {
      console.warn('[task] 删除失败', e);
      showToast('删除失败');
    });
  }

  var editingTaskId = null; // null = 新建
  function openTaskEditor(id) {
    editingTaskId = id || null;
    switchScreen('task-edit');
  }

  function renderTaskEditor() {
    var task = editingTaskId ? (D.home.tasks || []).find(function(t) { return t.id === editingTaskId; }) : null;
    var isEdit = !!task;
    var members = (window.activeMembers || []);
    var selectedIcon = task ? (task.icon || 'clipboard') : 'clipboard';

    var iconOptions = Object.keys(TASK_ICON_PRESETS).map(function(key) {
      return '<div class="ti-opt' + (key === selectedIcon ? ' on' : '') + '" data-icon="' + key + '" onclick="selectTaskIcon(\'' + key + '\')">' +
        '<svg viewBox="0 0 24 24" fill="none" stroke="' + TASK_ICON_PRESETS[key].stroke + '" stroke-width="2">' + TASK_ICON_PRESETS[key].path + '</svg></div>';
    }).join('');

    var memberOptions = '<option value="">不关联成员</option>' + members.map(function(m) {
      var sel = task && task.memberId === m.id ? ' selected' : '';
      return '<option value="' + m.id + '"' + sel + '>' + escapeHtml(m.nickname || '成员') + '</option>';
    }).join('');
    ...
    if (task && task.dueDate) {
      ...
      var pad = function(n) { return String(n).padStart(2, '0'); };
      dueVal = d.getFullYear() + '-' + pad(d.getMonth() + 1) + '-' + pad(d.getDate()) + 'T' + pad(d.getHours()) + ':' + pad(d.getMinutes());
    }

    var html = '<div class="status-bar"></div>' +
      '<div class="te-header"><button class="te-back" onclick="goBack()">‹</button>' +
      '<div class="te-title">' + (isEdit ? '编辑待办' : '新建待办') + '</div>' +
      '<button class="te-save" onclick="saveTask()">保存</button></div>' +
      '<div class="te-body">' +
        '<label class="te-label">标题</label>' +
        '<input id="te-title" class="te-input" maxlength="120" placeholder="例如：提醒爸爸测血压" value="' + (task ? escapeHtml(task.title) : '') + '">' +
        '<label class="te-label">备注</label>' +
        '<textarea id="te-detail" class="te-textarea" placeholder="补充说明（选填）">' + (task ? escapeHtml(task.detail || '') : '') + '</textarea>' +
        '<label class="te-label">关联成员</label>' +
        '<select id="te-member" class="te-input">' + memberOptions + '</select>' +
        '<label class="te-label">截止时间（选填）</label>' +
        '<input id="te-due" class="te-input" type="datetime-local" value="' + dueVal + '">' +
        '<label class="te-label">图标</label>' +
        '<div class="ti-grid">' + iconOptions + '</div>' +
        (isEdit ? '<button class="te-delete" onclick="deleteTaskItem(\'' + task.id + '\', null)">删除此待办</button>' : '') +
      '</div>';

    document.getElementById('content-task-edit').innerHTML = html;
    window.__selectedTaskIcon = selectedIcon;
  }

  function selectTaskIcon(key) {
    window.__selectedTaskIcon = key;
    document.querySelectorAll('.ti-opt').forEach(function(el) {
      el.classList.toggle('on', el.getAttribute('data-icon') === key);
    });
  }
  ...
  function saveTask() {
    ...
    var detail = document.getElementById('te-detail').value.trim();
    var memberId = document.getElementById('te-member').value || null;
    var dueRaw = document.getElementById('te-due').value;
    var dueDate = dueRaw ? new Date(dueRaw).toISOString() : null;
    var icon = window.__selectedTaskIcon || 'clipboard';
    var meta = TASK_ICON_PRESETS[icon] || TASK_ICON_PRESETS.clipboard;
    ...
    var dto = {
      ...
      icon: icon,
      iconBg: meta.bg,
      iconStroke: meta.stroke,
    };

    var p;
    if (editingTaskId) {
      p = window.API.updateTask(editingTaskId, dto);
    } else {
      dto.familyId = window.activeFamilyId;
      p = window.API.createTask(dto);
    }
    p.then(function(res) {
      var saved = res && res.data ? res.data : res;
      // 同步本地列表
      if (editingTaskId) {
        var idx = (D.home.tasks || []).findIndex(function(t) { return t.id === editingTaskId; });
        if (idx >= 0) {
          D.home.tasks[idx] = Object.assign({}, D.home.tasks[idx], {
            title: saved.title, detail: saved.detail, memberId: saved.memberId,
            dueDate: saved.dueDate, icon: saved.icon, iconBg: saved.iconBg, iconStroke: saved.iconStroke,
          });
        }
      } else {
        D.home.tasks = D.home.tasks || [];
        D.home.tasks.push({
          id: saved.id, title: saved.title, detail: saved.detail || '',
          memberId: saved.memberId || null, dueDate: saved.dueDate || null,
          icon: saved.icon, iconBg: saved.iconBg, iconStroke: saved.iconStroke, done: false,
        });
      }
      showToast('已保存');
      renderHome();
  ...
  async function ensureMemberContext() {
    ...
    // 2）无缓存 → 独立走完整解析链路
    try {
      // 2a) 确保 token 有效（浏览器预览走开发登录，微信小程序走 wx.login）
      if (!authToken) {
        var ok = await ensureAuthenticated();
        if (!ok) { console.warn('[consult] 未登录'); return null; }
      }
      ...
      API.consultStream(
        ...
        function(event, payload) {
          if (event === 'red_line' && payload.triggered) {
            ...
            // 流式结束后再一次性渲染 Markdown，避免中间状态解析错误/闪烁
            if (streamText) streamText.innerHTML = renderMarkdown(full);
  ...
  async function logout() {
    try {
      ...
      clearTokens();
      authToken = null; refreshToken = null; authUserId = null; authUser = null;
      showToast('已退出登录');
      // 刷新页面触发登录/注册浮层，因为 showAuthOverlay 是局部函数无法直接调用
  ...
  /* 轻量 Markdown 渲染（AI 咨询气泡用，仅支持常见安全语法） */
  ...
  function renderMarkdown(text) {
    ...
    blocks.forEach(function(block) {
      ...
      // 标题
      var hMatch = lines[0].match(/^(#{1,6})\s+(.+)$/);
      ...
      if (lines.every(function(l) { return /^\d+\.\s+/.test(l); })) {
        var items = lines.map(function(l) {
          return '<li>' + inlineFormat(l.replace(/^\d+\.\s+/, '')) + '</li>';
        });
  ...
  /** 由原始指标记录构造「最近指标」看板卡片 */
  function buildMetricCards(rows) {
    if (!Array.isArray(rows) || rows.length === 0) return [];
    // 按 metricType 分组并倒序（最新在前）
    var byType = {};
    ...
    Object.keys(byType).forEach(function(t) {
      byType[t].sort(function(a, b) { return new Date(b.recordedAt) - new Date(a.recordedAt); });
    });

    var cards = [];
    // 血压：合并收缩压/舒张压
    var sysRows = byType['blood_pressure_systolic'];
    var diaRows = byType['blood_pressure_diastolic'];
    if (sysRows && sysRows.length && diaRows && diaRows.length) {
      // 找时间上最接近的一组
      var sys = sysRows[0];
      var dia = diaRows.reduce(function(best, cur) {
        var bestDiff = Math.abs(new Date(best.recordedAt) - new Date(sys.recordedAt));
        var curDiff = Math.abs(new Date(cur.recordedAt) - new Date(sys.recordedAt));
        return curDiff < bestDiff ? cur : best;
      }, diaRows[0]);
      var meta = METRIC_CARD_META['blood_pressure'];
      cards.push(makeMetricCard('blood_pressure', meta, sys.value + '/' + dia.value, sys.unit, sysRows, { sys: sys.value, dia: dia.value }));
    } else if (sysRows && sysRows.length) {
      cards.push(makeMetricCard('blood_pressure_systolic', METRIC_CARD_META['blood_pressure_systolic'], sysRows[0].value, sysRows[0].unit, sysRows));
    } else if (diaRows && diaRows.length) {
      cards.push(makeMetricCard('blood_pressure_diastolic', METRIC_CARD_META['blood_pressure_diastolic'], diaRows[0].value, diaRows[0].unit, diaRows));
    }

    // 其他类型
    Object.keys(METRIC_CARD_META).forEach(function(type) {
      if (type === 'blood_pressure') return;
      var list = byType[type];
      if (!list || !list.length) return;
      var meta = METRIC_CARD_META[type];
      cards.push(makeMetricCard(type, meta, list[0].value, list[0].unit, list));
    });
    return cards;
  }

  function makeMetricCard(type, meta, value, unit, rows, extra) {
    var latest = rows[0];
    var prev = rows[1];
    var trend = 'flat';
    var trendPct = 0;
    if (prev && typeof latest.value === 'number' && typeof prev.value === 'number' && prev.value !== 0) {
      var diff = latest.value - prev.value;
      trendPct = Math.round((diff / Math.abs(prev.value)) * 100);
      trend = diff > 0.001 ? 'up' : (diff < -0.001 ? 'down' : 'flat');
    }
    var status = latest.status || 'normal';
    return {
      type: type,
      label: meta.label,
      value: meta.format ? meta.format(extra || value) : value,
      unit: unit || meta.unit,
  ...
  // ── 指标类型中文标签 ──
  var METRIC_LABELS = {
    blood_pressure: '血压', blood_pressure_systolic: '收缩压', blood_pressure_diastolic: '舒张压',
    blood_glucose_fasting: '空腹血糖', blood_glucose_postprandial: '餐后血糖', blood_glucose: '血糖',
    heart_rate: '心率', weight: '体重', height: '身高',
    body_fat: '体脂率', temperature: '体温', spo2: '血氧', blood_oxygen: '血氧',
    steps: '步数', sleep: '睡眠时长', bmi: 'BMI', stress: '压力指数',
  };

  // ── 指标看板卡片元数据（华为运动健康风格）──
  var METRIC_CARD_META = {
    blood_pressure: {
      label: '血压', unit: 'mmHg', combine: ['blood_pressure_systolic', 'blood_pressure_diastolic'],
      iconBg: 'rgba(208,128,104,.12)', iconStroke: '#D08068',
      icon: '<path d="M3 12h4l3-8 4 16 3-8h4"/>',
      format: function(v) { return v.sys + '/' + v.dia; },
    },
    weight: {
      label: '体重', unit: 'kg', iconBg: 'rgba(216,149,117,.12)', iconStroke: '#D89575',
      icon: '<rect x="3" y="8" width="18" height="8" rx="4"/>',
    },
    bmi: {
      label: 'BMI', unit: '', iconBg: 'rgba(180,140,200,.12)', iconStroke: '#B48CC8',
      icon: '<path d="M12 2a10 10 0 100 20 10 10 0 000-20zM8 12h8M12 8v8"/>',
    },
    body_fat: {
      label: '体脂率', unit: '%', iconBg: 'rgba(120,150,180,.12)', iconStroke: '#7896B4',
      icon: '<circle cx="12" cy="12" r="9"/><path d="M8 12a4 4 0 018 0"/>',
    },
    blood_glucose_fasting: {
      label: '空腹血糖', unit: 'mmol/L', iconBg: 'rgba(212,166,74,.12)', iconStroke: '#D4A64A',
      icon: '<circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 2"/>',
    },
    blood_glucose_postprandial: {
      label: '餐后血糖', unit: 'mmol/L', iconBg: 'rgba(212,166,74,.12)', iconStroke: '#D4A64A',
      icon: '<circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 2"/>',
    },
    heart_rate: {
      label: '心率', unit: 'bpm', iconBg: 'rgba(61,138,90,.12)', iconStroke: '#3D8A5A',
      icon: '<path d="M20.84 4.61a5.5 5.5 0 00-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 00-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 000-7.78z"/>',
    },
    spo2: {
      label: '血氧', unit: '%', iconBg: 'rgba(100,180,160,.12)', iconStroke: '#64B4A0',
    ...
    temperature: {
      label: '体温', unit: '°C', iconBg: 'rgba(220,120,100,.12)', iconStroke: '#DC7864',
      icon: '<path d="M14 14.76V3.5a2.5 2.5 0 00-5 0v11.26a4.5 4.5 0 105 0z"/>',
    },
    steps: {
      label: '步数', unit: '步', iconBg: 'rgba(80,160,220,.12)', iconStroke: '#50A0DC',
      icon: '<path d="M13 4v4h4M17 8l-6.5 6.5a2.12 2.12 0 01-3 0 2.12 2.12 0 010-3L14 2M8 15l3 3"/>',
    },
    sleep: {
      label: '睡眠', unit: '小时', iconBg: 'rgba(100,100,160,.12)', iconStroke: '#6464A0',
      icon: '<path d="M21 12.79A9 9 0 1111.21 3 7 7 0 0021 12.79z"/>',
    },
    stress: {
      label: '压力', unit: '分', iconBg: 'rgba(180,120,140,.12)', iconStroke: '#B4788C',
  ...
  (function() {
    ...
    // ── 认证状态 ──（authToken/refreshToken/authUserId/applyTokens 已提升至外层作用域，供 ensureMemberContext 共享）
    ...
    if (!resp.ok) {
      ...
      if (errBody) {
        ...
        else if (Array.isArray(errBody.message)) message = errBody.message.join('; ');
        else if (errBody.message) message = JSON.stringify(errBody.message);
      }
    ...
    function transformUser(nestjsUser) {
      var name = (nestjsUser && nestjsUser.nickname) ? nestjsUser.nickname : '用户';
      return {
        name: name,
    ...
    function transformHome(members) {
      ...
      // 判断是否有健康自评分数：取主成员或第一个成员的健康档案
      var primaryMember = members.find(function(m) { return m.isPrimary; }) ||
                          members.find(function(m) { return m.relation === 'self'; }) ||
                          members[0];
      var hr = primaryMember && primaryMember.healthRecord;
      var score = hr && hr.lastAssessmentScore ? parseFloat(hr.lastAssessmentScore) : null;
      var healthScore;
      if (score === null || isNaN(score)) {
        healthScore = { label: '家庭健康评分', value: '--', badge: '未评估', needAssessment: true };
      } else {
        var score100 = Math.round(score * 10);
        var badge = score100 >= 80 ? '良好' : score100 >= 60 ? '一般' : '需关注';
        healthScore = { label: '家庭健康评分', value: score100, badge: badge, needAssessment: false };
      }
    ...
    function transformArchive(members) {
      var avatarColors = ['var(--primary)', 'var(--tertiary)', 'var(--secondary)', 'var(--primary)'];
      var genderMap = { 1: '男', 2: '女' };
      var parentCount = members.filter(function(m) { return m.relation === 'parent'; }).length;
      var childCount = members.filter(function(m) { return m.relation === 'child'; }).length;
      return {
        summary: {
          title: '家庭健康概览',
          desc: members.length + ' 位成员' +
            (parentCount ? ' · ' + parentCount + ' 位长辈' : '') +
            (childCount ? ' · ' + childCount + ' 位孩子' : ' · 健康档案已同步'),
        },
        members: members.map(function(m, i) {
          var genderLabel = genderMap[m.gender] || '';
          return {
            id: m.id,
            ...
            avatarColor: avatarColors[i % avatarColors.length],
            name: (m.nickname || '?') + ' · ' + (m.relation || '成员'),
            detail: (m.age ? m.age + '岁' : '') + (genderLabel ? (m.age ? ' · ' : '') + genderLabel : ''),
    ...
    function transformMemberDetail(member, healthRecord, idx) {
      ...
      var chronicStr = '';
      try { var cd = JSON.parse(healthRecord && healthRecord.chronicDiseases || '[]'); chronicStr = cd.map(function(x) { return typeof x === 'string' ? x : (x && x.name ? x.name : ''); }).filter(Boolean).join(' · '); } catch(e) {}
      ...
      return {
        ...
        metrics: [], // 由 syncFromBackend 注入真实指标看板数据
        medications: [],
    ...
    var API = {
      ...
      smartLogin: function() {
        return new Promise(function(resolve, reject) {
          ...
          function doLogin() {
            // 浏览器本地开发/演示模式：允许开发身份登录（后端 NODE_ENV=development + ALLOW_DEV_IDENTITY=true 时生效）
            // 使用固定 code，保证同一浏览器/设备始终对应同一个开发用户
            if (runtimeConfig.allowDevIdentity === true) {
              API.login('dev-local-fixed').then(resolve).catch(reject);
              return;
            }
      ...
      getUserStats: function() { return apiFetch('/users/me/stats'); },
      ...
      // ── 家庭成员（真实后端）──
      createMember: function(familyId, data) {
        return apiFetch('/families/' + familyId + '/members', { method: 'POST', body: JSON.stringify(data) });
      },
      updateMember: function(familyId, memberId, data) {
        return apiFetch('/families/' + familyId + '/members/' + memberId, { method: 'PATCH', body: JSON.stringify(data) });
      },
      removeMember: function(familyId, memberId) {
        return apiFetch('/families/' + familyId + '/members/' + memberId, { method: 'DELETE' });
      },
      updateChronicDiseases: function(memberId, diseases) {
        return apiFetch('/health-records/' + memberId + '/chronic-diseases', {
          method: 'PATCH', body: JSON.stringify({ diseases: diseases || [] })
        });
      },

      // ── 用药管理（真实后端）──
      createMedication: function(data) {
      ...
      // ── 健康指标（真实后端）──
      getMetrics: function(memberId, type, limit) {
      ...
      recordMetricsBatch: function(data) {
        return apiFetch('/metrics/batch', { method: 'POST', body: JSON.stringify(data) });
      },
      ...
      submitAnswer: function(sessionId, payload) {
        return apiFetch('/assessments/answer', {
          method: 'POST',
          body: JSON.stringify(Object.assign({}, payload, { sessionId: sessionId })),
        });
      },
      ...
      // ── 待办事项（真实后端）──
      getTasks: function(familyId, done) {
        var qs = 'familyId=' + familyId + (done !== undefined ? '&done=' + done : '');
        return apiFetch('/tasks?' + qs);
      },
      createTask: function(dto) {
        return apiFetch('/tasks', { method: 'POST', body: JSON.stringify(dto) });
      },
      updateTask: function(id, dto) {
        return apiFetch('/tasks/' + id, { method: 'PATCH', body: JSON.stringify(dto) });
      },
    ...
    async function syncFromBackend() {
      ...
      // Step 1: 账号密码登录/注册门禁（恢复 localStorage token 或弹出登录界面）
      console.log('[API] Step 1: 鉴权...');
      var authed = await ensureAuthenticated();
      if (!authed) {
        console.warn('[API] 未登录，使用本地数据');
        return false;
      }
      var authUser = await API.getMe();
      authUserId = authUser.id;
      console.log('[API] 登录成功 ✅ user=' + (authUser.nickname || authUser.email || authUser.id) + ' (' + authUserId + ')');
      ...
      D.addMed.members = members.map(function(m) { return { id: m.id, name: m.nickname || '成员' }; });
      D.recordMetric.measurers = members.map(function(m) { return m.nickname || '成员'; });
      ...
      // Step 4+ 真实统计（家庭成员/健康记录/咨询次数）
      try {
        var userStats = await window.API.getUserStats();
        if (userStats && typeof userStats === 'object') {
          D.user.stats = [
            { value: String(activeMembers.length), label: '家庭成员' },
            { value: String(userStats.healthRecordCount || userStats.metricCount || 0), label: '健康记录' },
            { value: String(userStats.consultationCount || 0), label: '咨询次数' },
          ];
          console.log('[API] 用户统计: 成员' + activeMembers.length + ', 健康记录' + (userStats.healthRecordCount || 0) + ', 咨询' + (userStats.consultationCount || 0));
        }
      } catch (e) { console.warn('[API] 用户统计加载失败', e); }
      ...
      // 首页待办事项（真实后端）
      try {
        var rawTasks = await window.API.getTasks(activeFamilyId);
        var taskList = Array.isArray(rawTasks) ? rawTasks : (rawTasks && Array.isArray(rawTasks.data) ? rawTasks.data : []);
        D.home.tasks = taskList.map(function(t) {
          return {
            id: t.id,
            title: t.title,
            detail: t.detail || '',
            icon: t.icon || 'clipboard',
            iconBg: t.iconBg || 'rgba(61,138,90,.1)',
            iconStroke: t.iconStroke || '#3D8A5A',
            done: !!t.done,
        ...
        var openCount = D.home.tasks.filter(function(t) { return !t.done; }).length;
        D.home.statsRow = (D.home.statsRow || []).map(function(s) {
          if (s.label === '待办事项') return Object.assign({}, s, { value: openCount + '件' });
          return s;
        });
        console.log('[API] 待办事项: ' + D.home.tasks.length + ' 条 (未完成 ' + openCount + ')');
      } catch (e) { console.warn('[API] 待办事项加载失败', e); }
      ...
      // Step 4b/4c: 今日用药 + 健康指标（并行，减少 syncFromBackend 总耗时）
      if (primaryMemberId) {
        await Promise.all([
          (async function() {
            try {
          ...
          (async function() {
            try {
              ...
              if (Array.isArray(metricRows) && metricRows.length) {
                var metricCards = buildMetricCards(metricRows);
                if (metricCards.length) D.metrics.metrics = metricCards;
              }
              var [sysTrend, diaTrend] = await Promise.all([
                API.getMetricTrend(primaryMemberId, 'blood_pressure_systolic', 7),
                API.getMetricTrend(primaryMemberId, 'blood_pressure_diastolic', 7)
              ]);
      ...
      // Step 5: 加载每个成员的详情（异步并行，减少 TiDB 高延迟 RTT 累积）
      console.log('[API] Step 5: 加载成员详情...');
      var memberDetails = (await Promise.all(members.map(function(m, i) {
        return Promise.all([
          API.getMemberDetail(m.id).catch(function(e) { console.warn('[API] 成员详情失败', m.id, e); return null; }),
          API.getHealthRecord(m.id).catch(function(e) { console.warn('[API] 健康档案失败', m.id, e); return null; })
        ]).then(function(res) {
          return res[0] ? transformMemberDetail(res[0], res[1], i) : null;
        });
      }))).filter(Boolean);
      ...
      // Step 5b: 为每个成员注入真实指标 & 用药（并行）
      try {
        await Promise.all(memberDetails.map(function(md, mi) {
          var mem = members[mi];
          if (!mem) return Promise.resolve();
          return Promise.all([
            API.getMetrics(mem.id).catch(function(e) { console.warn('[API] 指标失败', mem.id, e); return []; }),
            API.getMedications(mem.id, true).catch(function(e) { console.warn('[API] 用药失败', mem.id, e); return []; })
          ]).then(function(res) {
            var mRows = res[0];
            var plans = res[1];
            if (Array.isArray(mRows) && mRows.length) {
              var cards = buildMetricCards(mRows);
              if (cards.length) memberDetails[mi].metrics = cards;
            }
  ...
  document.addEventListener('click', function(event) {
    ...
    var allowed = {
      ...
      openMemberDetail: openMemberDetail, toggleTaskDone: toggleTaskDone,
      ...
      sendChat: sendChat, submitMetric: saveRecordMetric, addMedication: saveAddMed,
      openTaskEditor: openTaskEditor, toggleTaskDone: toggleTaskDone,
      deleteTaskItem: deleteTaskItem, selectTaskIcon: selectTaskIcon, saveTask: saveTask
    };
